...
public class ModBlocks {
    ...
    public static final Block TRANSMUTATION_TABLE = new Block(FabricBlockSettings.of(Material.STONE).strength(3.0f, 20.0f).sounds(BlockSoundGroup.STONE));

    public static void registerBlocks(){
        ModBlocks.registerFuelBlocks();
        ModBlocks.registerTransmutationBlocks();
    }
    ...
    public static void registerTransmutationBlocks() {
        Registry.register(Registry.BLOCK, new Identifier(Equivalence.MOD_ID, "transmutation_table"), TRANSMUTATION_TABLE);
    }
}
